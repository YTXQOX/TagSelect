package com.ljstudio.android.tagselect.views.flowlayout;
...
import com.ljstudio.android.tagselect.R;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private int mMaxPosition = -1; //1个亿
    ...
    public void setMaxSelectPosition(int position) {
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public boolean performClick() {
        ...
        if (child != null && pos < mMaxPosition) {
            doSelect(child, pos);
